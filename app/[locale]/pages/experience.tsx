...
export default function About() {
  ...
  return (
    <main id="experience" className="flex max-h-[1000px] py-[80px] flex-row
    md:items-center justify-center gap-8 px-8 md:h-screen md:py-[390px] md:max-h-[900px] 2xl:py-[360px] 2xl:h-screen
